...
export const OFF_BASE_DEFAULT: { x: number; d: number }[] = [
  ...
  { x: -5.80, d: 4.35 },   // 1 左ウイング（7.25m）
  { x: 5.80, d: 4.35 },    // 2 右ウイング（7.25m）
  { x: -6.85, d: 2.37 },   // 3 左コーナー（7.25m / x はコートのクランプ ±7.0 の内側）
  { x: 6.85, d: 2.37 },    // 4 右コーナー（7.25m）
  ...
  { x: 4.2, d: 1.0 },      // 6 右ショートコーナー（中は空けるが、ゴール下の高さに留まる）
];
export class Game {
